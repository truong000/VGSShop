...
namespace VGSShop.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public AdminPagesController(VGSShopContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDesc,MetaKey,Alias,CreateAt,Ordering")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                { //Xử lý hình ảnh thumb
                    ...
                    await _context.SaveChangesAsync();
                    _notyfService.Success("Chỉnh sửa PAGES thành công");
                }
