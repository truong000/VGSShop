...
namespace VGSShop.Areas.Admin.Controllers
{
    ...
    public class FeedbacksController : Controller
    {
        ...
        public FeedbacksController(VGSShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email,Address,Content,CreatedDate,Status")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,Address,Content,CreatedDate,Status")] Feedback feedback)
        {
            if (id != feedback.Id)
            {
                return NotFound();
