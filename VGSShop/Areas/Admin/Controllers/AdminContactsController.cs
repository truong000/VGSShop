...
namespace VGSShop.Areas.Admin.Controllers
{
    ...
    public class AdminContactsController : Controller
    {
        ...
        public AdminContactsController(VGSShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email,Address,Content,CreatedDate,Status")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,Address,Content,CreatedDate,Status")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
